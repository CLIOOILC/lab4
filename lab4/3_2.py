...
# 特征工程
assembler = VectorAssembler(inputCols=["Sex", "City", "constellation", "year", "month", "dayofweek", "mfd_daily_yield", "Interest_O_N", "Interest_1_W", "Interest_2_W", "Interest_1_M", "Interest_3_M", "Interest_6_M", "Interest_9_M", "Interest_1_Y"], outputCol="features")
